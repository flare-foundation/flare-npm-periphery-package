...
export const nameToAbi = (name: string): any => {
    ...
    throw new Error(
        `Unknown exception occured. Could not find any official Flare Network contract with name "${name}".`
    );
};
...
export const interfaceToAbi = (name: string): any => {
    ...
    throw new Error(
        `Unknown exception occured. Could not find any official Flare Network interface with name "${name}".`
    );
};
