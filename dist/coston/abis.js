...
const IIInflationReceiverV1_json_1 = __importDefault(require("./artifacts/contracts/inflation/interface/IIInflationReceiverV1.sol/IIInflationReceiverV1.json"));
...
const SelfDestructBurner_json_1 = __importDefault(require("./artifacts/contracts/inflation/implementation/SelfDestructBurner.sol/SelfDestructBurner.json"));
const InflationRewardServices_json_1 = __importDefault(require("./artifacts/contracts/inflation/lib/InflationRewardServices.sol/InflationRewardServices.json"));
const InflationTimeSlots_json_1 = __importDefault(require("./artifacts/contracts/inflation/lib/InflationTimeSlots.sol/InflationTimeSlots.json"));
...
const TokenPoolBase_json_1 = __importDefault(require("./artifacts/contracts/tokenPools/implementation/TokenPoolBase.sol/TokenPoolBase.json"));
...
const InflationReceiver_json_1 = __importDefault(require("./artifacts/contracts/tokenPools/implementation/InflationReceiver.sol/InflationReceiver.json"));
...
exports.abis = {
    ...
    IIInflationReceiverV1: IIInflationReceiverV1_json_1.default.abi,
    ...
    SelfDestructBurner: SelfDestructBurner_json_1.default.abi,
    InflationRewardServices: InflationRewardServices_json_1.default.abi,
    InflationTimeSlots: InflationTimeSlots_json_1.default.abi,
    ...
    TokenPoolBase: TokenPoolBase_json_1.default.abi,
    FtsoRewardManager: FtsoRewardManager_json_1.default.abi,
    InflationReceiver: InflationReceiver_json_1.default.abi,
